ytTweaks.tweaks.push(function (settings) {
    if (settings.compactHeaderBar)
        ...
        #container.ytd-masthead {
          ...
          background: var(--app-drawer-content-container-background-color) !important;
        }
        ytd-button-renderer.ytd-masthead button[aria-label="Search with your voice"] {
          width: 30px !important;
          height: 30px !important;
        }
        ytd-button-renderer.ytd-masthead button[aria-label="Search with your voice"] .ytSpecButtonShapeNextIcon,
        ytd-button-renderer.ytd-masthead button .ytIconWrapperHost,
        ytd-button-renderer.ytd-masthead button .ytSpecButtonShapeNextIcon,
        .ytSearchboxComponentSearchButton > span:nth-child(1),
        .ytSearchboxComponentInnerSearchIcon,
        .ytSearchboxComponentInnerSearchIcon > span:nth-child(1)
        {
          width: 18px !important;
          height: 18px !important;
        }
        ytd-button-renderer.ytd-masthead button[aria-label="Create"] {
          height: 30px !important;
        }
    `;
    ...
    if (settings.ytLogoSubsPage) {
        ...
        function setCustomPage(e) {
            if (
                e.detail.endpoint &&
                confirm(
                    `Make logo redirect to this page? (${e.detail.endpoint?.commandMetadata?.webCommandMetadata?.url})`,
                )
            ) {
                ...
                document.dispatchEvent(
                    new CustomEvent("yttwSaveSetting", {
                        detail: {
        ...
        function redirect(e) {
            ...
            document
                ...
                .handleNavigate({ command: command });
        }
