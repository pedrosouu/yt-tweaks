...
- **Menu Options**:
  ...
  - Theme Switcher with over 100 YouTube themes
...
[Unreleased]: https://github.com/pedrosouu/yt-tweaks/compare/pedrosouu:yt-tweaks:main...pedrosouu:yt-tweaks:main

<!-- --------- FOOTER --------- -->
<!-- Key for the format below: R = Release First Letter, CT = Change Type First Letter, CC = Change Organization Category First Letters of Each Word -->
<!-- ...Continued: CN = Change Name First Letters of Each Word + Iteration Number (Iteration numbers are used for avoiding conflict issues) -->
<!-- Reference superscript links format is [^R-CT-CC-CN] -->
[^u-a-mp-cc1]: *Custom Code* supports:
    ```
    - CSS
    - JavaScript
    ```
